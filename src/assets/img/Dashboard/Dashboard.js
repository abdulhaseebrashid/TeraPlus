    ...
    <div className="dashboard-container">
      ...
      <div className="main-content">
        <div className="dashboard-header">
          ...
          <div className="dashboard-title" style={{ minWidth: 120, marginLeft:500,fontSize:20 }}>לוח בקרה</div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                          <li><a className="dropdown-item" href="#">היום</a></li>
                          <li><a className="dropdown-item active" href="#">החודש</a></li>
                          <li><a className="dropdown-item" href="#">השנה</a></li>
                        </ul>
                      </div>
                    </div>
                    <Chart
                  ...
                  <div className="card p-3 h-100">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <div className="btn-group" role="group">
                        <button type="button" className="btn btn-sm btn-outline-secondary">יום</button>
                        <button type="button" className="btn btn-sm btn-outline-secondary active">שבוע</button>
                        <button type="button" className="btn btn-sm btn-outline-secondary">חודש</button>
                        <button type="button" className="btn btn-sm btn-outline-secondary">שנה</button>
                      </div>
                    </div>
                    <Chart
                      chartType="LineChart"
              ...
              <div className="container" dir="rtl" >
                <div className="row g-4">
                  <div className="col-12 col-md-6">
                    <div className="cardrep report-card">
                      <div className="report-card-header">
                        <img src={userreport} alt="לקוחות" className="report-card-icon" />

                        <span className="report-card-title">לקוחות</span>
                      </div>
                      <div className="report-card-body">
                        <div className="report-card-desc">
                          צפו ונהלו את כל השירותים ללקוחות בעסק. הדוחות מציגים את סך סוגי הלקוחות ונותנים לכם תובנות לכל סוג לקוח וסטטיסטיקה.
                        </div>
                        <ul className="report-card-list">
                          <li>
                            <Link to="/joined-customer-report">לקוחות שצורפו</Link>
                          </li>
                          <li>
                            <Link to="/customer-churn-report">לקוחות שעזבו</Link>
                          </li>
                          <li>
                            <Link to="/realization-of-royalities">לקוחות VIP</Link>
                          </li>
                          <li>
                            <Link to="/realization-of-royalities">מימוש מדדים</Link>
                          </li>   
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-12 col-md-6">
                    <div className="cardrep report-card">
                      <div className="report-card-header">
                        <img src={report2} alt="תורים" className="report-card-icon" />

                        <span className="report-card-title">תורים</span>
                      </div>
                      <div className="report-card-body">
                        <div className="report-card-desc">
                          תצוגה וניתוח מידע לגבי תורים שנקבעו והמומשו על ידי הלקוחות שלכם לפי סניף, סניפים, ולצפות בפרטים שונים על תורים שהוקלטו במערכת.
                        </div>
                        <ul className="report-card-list">
                          <li>
                            <Link to="/qeueu-report">דו"ח תורים</Link>
                          </li>
                          <li>
                            <Link to="/qeueu-report">דו"ח תורים שבועי</Link>
                          </li>
                          <li>
                            <Link to="/team-presence">נוכחות צוות</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-12 col-md-6">
                    <div className="cardrep report-card">
                      <div className="report-card-header">
                        <img src={report3} alt="מערכת" className="report-card-icon" />

                        <span className="report-card-title">כספים</span>
                      </div>
                      <div className="report-card-body">
                        <div className="report-card-desc">
                          סקירה על התשלומים וההכנסות בעסק עם דוחות על תשלומים לפי לקוח, תקבלו את כל המידע הרלוונטי בחלוקה לדו״חות
                        </div>
                        <ul className="report-card-list">
                          <li>
                            <Link to="/report-recipt">דו״ח תקבולים</Link>
                          </li>
                          <li>
                            <Link to="/refund-report">דו״ח זיכויים</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-12 col-md-6">
                    <div className="cardrep report-card">
                      <div className="report-card-header">
                        <img src={report4} alt="כספים" className="report-card-icon" />

                        <span className="report-card-title">מערכת</span>
                      </div>
                      <div className="report-card-body">
                        <div className="report-card-desc">
                          לצפות בצורה קלה ונוחה אחר פעילות המערכת כגון הודעות שנשלחו ללקוחות, תקבלו מידע מפורט על כל פעילות של הצוות במערכת.
                        </div>
                        <ul className="report-card-list">
                          <li>
                            <Link to="/sent-message-report">הודעות שנשלחו</Link>
                          </li>
                          <li>
                            <Link to="/system-log">לוג מערכת</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
